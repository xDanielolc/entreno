...
export const CATALOGO = [
  ...
  ej('Cinta de correr', 'cardio', 'máquina', [], ['cuadriceps', 'gemelo'], { ...sinCarga, distancia: true }),
  ej('Bicicleta estática', 'cardio', 'máquina', [], ['cuadriceps'], { ...sinCarga, distancia: true }),
  ej('Spinning', 'cardio', 'bici de sala', [], ['cuadriceps', 'gluteo'], { ...sinCarga, distancia: true }),
  ej('Cinta de andar en cuesta', 'cardio', 'máquina', [], ['gluteo', 'gemelo'], { ...sinCarga, distancia: true }),
  ej('Escalera sin fin', 'cardio', 'máquina', ['cuadriceps'], ['gluteo', 'gemelo'], { ...sinCarga, distancia: true }),
  ej('Esquí de fondo (máquina)', 'cardio', 'máquina', [], ['dorsal', 'cuadriceps'], { ...sinCarga, distancia: true }),
  ej('Patinaje', 'cardio', 'patines', [], ['cuadriceps', 'gluteo'], { ...sinCarga, distancia: true }),
  ej('Baile', 'cardio', 'libre', [], ['cuadriceps', 'gemelo'], sinCarga),
  ej('Sprints', 'cardio', 'libre', [], ['isquios', 'gluteo', 'gemelo'], { ...sinCarga, distancia: true }),
  ej('Paseo del granjero', 'cardio', 'mancuernas', ['antebrazo', 'trapecio'], ['abdomen', 'gemelo'], { esfuerzo: 'tiempo', distancia: true }),
  ej('Trineo (empujar)', 'cardio', 'trineo', ['cuadriceps'], ['gluteo', 'gemelo'], { esfuerzo: 'tiempo', distancia: true }),
  ej('Battle ropes', 'cardio', 'cuerdas', ['hombro'], ['abdomen', 'antebrazo'], sinCarga),
  ej('Air squat', 'cardio', 'peso corporal', ['cuadriceps'], ['gluteo'], { carga: 'ninguna', esfuerzo: 'repeticiones' }),
  ej('Mountain climbers', 'cardio', 'peso corporal', ['abdomen'], ['hombro', 'cuadriceps'], sinCarga),
  ej('Kettlebell swing', 'cardio', 'kettlebell', ['gluteo', 'isquios'], ['lumbar', 'hombro'], { esfuerzo: 'repeticiones' }),
  ...
  movilidad('Deslizamiento neural ciático', ['isquios'], ['lumbar']),
  movilidad('Deslizamiento neural cervical', ['cuello'], ['antebrazo']),
  movilidad('Rotación tibial con rodilla flexionada', ['tibial'], ['gemelo']),
  estiramiento('Estiramiento de sóleo en pared', ['gemelo'], [], 'pared'),
  movilidad('Rotación torácica en cuadrupedia', ['dorsal'], ['oblicuos']),
  ...
  movilidad('Flexión lateral de cuello activa', ['cuello'], ['trapecio'], 'libre', { esfuerzo: 'repeticiones' }),
  movilidad('Extensión torácica sobre rodillo', ['dorsal'], ['pecho'], 'rodillo', { esfuerzo: 'repeticiones' }),
  movilidad('Elevaciones Y-T-W', ['hombroPosterior'], ['trapecio'], 'suelo', { esfuerzo: 'repeticiones' }),
  movilidad('Cobra en el suelo', ['lumbar'], ['hombroPosterior', 'gluteo'], 'suelo'),
  estiramiento('Estiramiento del sofá (couch stretch)', ['cuadriceps'], ['gluteo'], 'pared'),
  estiramiento('Estiramiento de glúteo en paloma', ['gluteo'], ['cuadriceps']),
  movilidad('Flexión y extensión de dedos del pie', ['tibial'], ['gemelo'], 'libre', { esfuerzo: 'repeticiones' }),
  movilidad('Isométrico de flexión plantar', ['gemelo'], ['tibial']),
  estiramiento('Estiramiento del empeine', ['tibial'], []),
  estiramiento('Estiramiento de los dedos del pie', ['tibial'], ['gemelo']),
